...
`manifest` is the [manifest](/developer/manifest/) of the app to be installed. This
...
`manifest` is the [Cloudron Manifest](/developer/manifest/) of the app.
...
`manifest` is the [application manifest](/developer/manifest/).
